...
namespace WPMechanic\KBFNR\Common\Db;
...
class MDBWPDB extends \WPDB {
	...
	public function strip_invalid_text_from_query( $query ) {
		$query    = apply_filters( 'kbfnr_before_strip_invalid_text_from_query', $query );
		$fallback = false;
		...
		$this->last_stripped_query = apply_filters( 'kbfnr_after_strip_invalid_text_from_query', $query, $fallback );
